...
function all()
{
    ...
    KERNEL_VER_CLEAN=${KERNEL_VER%%-*}
    make ARCH=${ARCH_KERNEL} O=${BUILD_OUTPUT_PATH} INSTALL_MOD_PATH=${BUILD_OUTPUT_PATH}/_debug KERNELRELEASE=${KERNEL_VER_CLEAN} \
         INSTALL_NO_SUBDIR=1 MODULE_SIG_KEY_SRCPREFIX=${BUILD_OUTPUT_PATH}/ modules_install || {
	...
	make ARCH=${ARCH_KERNEL} O=${BUILD_OUTPUT_PATH} INSTALL_MOD_PATH=${TARGET_TMPROOTFS_DIR}/ KERNELRELEASE=${KERNEL_VER_CLEAN} \
         INSTALL_MOD_STRIP=1 INSTALL_NO_SUBDIR=1 MODULE_SIG_KEY_SRCPREFIX=${BUILD_OUTPUT_PATH}/ modules_install || {
