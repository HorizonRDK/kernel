...
static struct uvcg_config_group_type uvcg_framebased_grp_type = {
	.type = {
		.ct_item_ops	= &uvcg_config_item_ops,
...
{
	static char * const names[] = { "fs", "hs", "ss" };
	unsigned int i;
...
UVCG_OPTS_ATTR(streaming_multi_altsetting, streaming_multi_altsetting, 1);
...
static struct configfs_attribute *uvc_attrs[] = {
	...
	&f_uvc_opts_attr_streaming_multi_altsetting,
	NULL,
};
