...
#define LOG_DBG(fmt,arg...) pr_debug("ft5406: %s: "fmt, __func__, ##arg);
#define LOG_INFO(fmt,arg...) pr_info("ft5406: %s: "fmt, __func__, ##arg);
#define LOG_ERR(fmt,arg...) pr_err("ft5406: %s: "fmt, __func__, ##arg);
