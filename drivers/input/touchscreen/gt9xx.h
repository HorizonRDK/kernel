...
#define GT9XX_ADDR 0x14 // 0x14 0x5d

#define GTP_MAX_HEIGHT	1280
#define GTP_MAX_WIDTH	720

#define GTP_CHANGE_X2Y		0	   //swap x y
#define GTP_REVERT_X_FLAG	0
#define GTP_REVERT_Y_FLAG	0

#define GTP_RST_PORT   64
#define GTP_INT_PORT   26
...
static unsigned char CTP_CFG_GROUP0[] = {
#if 1
	#include "gt92xx.cfg"
#else
...
#define GTP_GPIO_SET_VALUE(pin,level)   do{gpio_set_value(pin,level);}while(0)
