...
///4K2K
#define HDMI_4k2k30	13
#define HDMI_4k2k25	14
#define HDMI_4k2k24	15
#define HDMI_4k2k24_SMPTE	16

///3D
#define HDMI_480P60_SIDE_BY_SIDE_HALF_4X3	17
#define HDMI_480P50_SIDE_BY_SIDE_HALF		18

#define HDMI_720P60_FRAME_PACKING	19
#define HDMI_720P50_FRAME_PACKING	20
#define HDMI_720P50_VMD_3D_LDEPTH	21
#define HDMI_720P50_VMD_3D_LDEPTHGRAPHICS	22

#define HDMI_1080I60_FRAME_PACKING	23
#define HDMI_1080I60_VMD_3D_FIELDALTERNATIVE	24
#define HDMI_1080P60_FRAME_PACKING	25
#define HDMI_1080P60_VMD_3D_FIELDALTERNATIVE	26
#define HDMI_1080P60_SIDE_BY_SIDE_FULL	27
#define HDMI_1080P60_SIDE_BY_SIDE_HALF	28
#define HDMI_1080I50_FRAME_PACKING	29
#define HDMI_1080I50_VMD_3D_FIELDALTERNATIVE	30
#define HDMI_1080P50_FRAME_PACKING	31
#define HDMI_1080P50_VMD_3D_FIELDALTERNATIVE	32
...
typedef struct {
	...
	// 2 = embedded sync
	byte TclkSel;
	// 0 = x0.5CLK; 1 = x1CLK; 2 = x2CLK; 3 = x4CLK
	byte ThreeDStructure;
	// Valid when (HDMIVideoFormat == VMD_HDMIFORMAT_3D)
	byte ThreeDExtData;
	// Valid when (HDMIVideoFormat == VMD_HDMIFORMAT_3D) &&
	// (ThreeDStructure == VMD_3D_SIDEBYSIDEHALF)
	byte AudioMode;
	// 0 = I2S; 1 = S/PDIF; 2 = HBR; 3 = DSD;
	byte AudioChannels;
	// 1 = 2chs; 2 = 3chs; 3 = 4chs; 4 = 5chs; 5 = 6chs; 6 = 7chs; 7 = 8chs;
	byte AudioFs;
	// 0-44.1kHz; 2-48kHz; 3-32kHz; 8-88.2kHz; 9-768kHz;
	// A-96kHz; C-176.4kHz; E-192kHz; 1/4/5/6/7/B/D/F-not indicated
	byte AudioWordLength;
	// 0/1-not available; 2-16 bit; 4-18 bit; 8-19 bit; A-20 bit;
	// C-17 bit; 5-22 bit; 9-23 bit; B-24 bit; D-21 bit
	byte AudioI2SFormat;
	// Please refer to TPI reg0x20 for detailed.
	//[7]_SCK Sample Edge: 0 = Falling; 1 = Rising
	//[6:4]_MCLK Multiplier: 000:MCLK=128Fs; 001:MCLK=256Fs; 010:MCLK=384Fs;
	//011:MCLK=512Fs; 100:MCLK=768Fs; 101:MCLK=1024Fs; 110:MCLK=1152Fs;
	//111:MCLK=192Fs;
	//[3]_WS Polarity-Left when: 0 = WS is low when Left;
	//1 = WS is high when Left
...
#define IsCEC_DEVICE()	\
	(((g_edid.CEC_A_B != 0xFF) && (g_edid.CEC_C_D != 0xFF)) ? TRUE : FALSE)
...
#define TPI_DEBUG_PRINT(fmt, args...)	\
	printk(KERN_DEBUG "%s " fmt, __func__, ## args)
#else
#define TPI_DEBUG_PRINT(fmt, args...)
#endif
...
// EDID Print Macro
// Note: To enable EDID description printing, both CONF__TPI_EDID_PRINT
// and CONF__TPI_DEBUG_PRINT must be enabled
...
// Note: To enable CPI description printing, both CONF__CPI_DEBUG_PRINT
// and CONF__TPI_DEBUG_PRINT must be enabled
...
// 3D Constants
//====================================================
#define _3D_STRUCT_PRESENT	0x02

// 3D_Structure Constants
//====================================================
...
//Set TPI_AVI_BYTE_2 to extended colorimetry and use TPI_AVI_BYTE_3
...
byte I2CWriteBlock(struct i2c_client *client, byte RegAddr,
		byte NBytes, byte *Data);
byte siiReadSegmentBlockEDID(struct i2c_client *client,
