...
/*IEEE Std 80211v, Figure 7-95e XBSS Termination Duration subelement field format */
...
/*IEEE Std 80211v, Figure 7-101n XBSS Transition Management Request frame body format */
struct btm_req_hdr {
	u8 req_mode;
	u16 disassoc_timer;
