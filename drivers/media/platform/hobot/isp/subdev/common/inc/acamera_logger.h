...
#ifndef DRIVERS_MEDIA_PLATFORM_HOBOT_ISP_SUBDEV_COMMON_INC_ACAMERA_LOGGER_H_
#define DRIVERS_MEDIA_PLATFORM_HOBOT_ISP_SUBDEV_COMMON_INC_ACAMERA_LOGGER_H_
...
extern void LOG_INTER(const char *const func, const char *const file,
const unsigned line, const uint32_t level, const uint32_t log_module,
const char *const fmt, ...);
extern void ACAMERA_LOGGER_SET_LEVEL(uint8_t level);
extern void ACAMERA_LOGGER_SET_MASK(uint32_t mask);

#define CUR_MOD_NAME LOG_MODULE_FW_GENERIC
...
#endif // DRIVERS_MEDIA_PLATFORM_HOBOT_ISP_SUBDEV_COMMON_INC_ACAMERA_LOGGER_H_
