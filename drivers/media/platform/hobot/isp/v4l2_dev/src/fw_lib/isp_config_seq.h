...
{ 0x18f98, 0x20003L, 0x70007,4 },
{ 0x18eac, 0x30L, 0x30,1 },
{ 0x18e8c, 0x2000000L, 0x3000000,4 },
//stop sequence - address is 0x0000
{ 0x0000, 0x0000, 0x0000, 0x0000 }
};
#else //HOBOT_NATIVE_WDR
static acam_reg_t linear[] = {
...
static acam_reg_t settings[] = {
    ...
    { 0x3c, 0x0L, 0x1,1 },      // set interrupt to level high trigger
    { 0x40, 0x1L, 0x1,1 },
    { 0x44, 0x0L, 0x0,4 },
    { 0x50, 0x3L, 0xf,1 },
    { 0x54, 0x1L, 0xfff,2 },
...
static acam_reg_t fs_lin_2exp[] = {
    { 0x18ed4, 0x03020100L, 0x3030303,4 },
//		{ 0x18ed4, 0x00000000L, 0x3030303,4 },
//	    { 0x18ed4, 0x01010101L, 0x3030303,4 },
    { 0x18eac, 0x0L, 0x30,1 },
    { 0x18f98, 0x10007L, 0x70007,4 },
    { 0x18e8c, 0x1000000L, 0x3000000,4 },
    { 0x18fe4, 0x1L, 0xff03,2 },
    { 0x18fe8, 0x400L, 0x0fff0fff,4 },
    { 0x18ff0, 0x0c000f00L, 0x0fff0fff,4 },
    { 0x18ffc, 0x00f000f0L, 0x0fff0fff,4 },
    { 0x19004, 0xf0L, 0xfffff,3 },
    //stop sequence - address is 0x0000
    { 0x0000, 0x0000, 0x0000, 0x0000 }
};
...
static acam_reg_t fs_lin_3exp[] = {
    { 0x18ed4, 0x3020100L, 0x3030303,4 },
//	      { 0x18ed4, 0x00000000L, 0x3030303,4 },
//	      { 0x18ed4, 0x01010101L, 0x3030303,4 },
//	      { 0x18ed4, 0x02020202L, 0x3030303,4 },
    { 0x18eac, 0x0L, 0x30,1 },
    { 0x18f98, 0x10007L, 0x70007,4 },
    { 0x18e8c, 0x1000000L, 0x3000000,4 },
    { 0x18fe4, 0x2L, 0x3,1 },
...
static acam_reg_t settings_context[] = {
    ...
    { 0x1abbc, 0x0L, 0x1,1 },
    { 0x1926c, 0x100L, 0x1fff,2 },                      // digital gain set to 0x100
...
//	    { 0x18e8c, 0x303L, 0x303,4 },                   // default change to bggr
//	    { (0x18e8c+0x17fb0), 0x303L, 0x303,4 },         // default change to bggr
    ...
    { 0x1b0dc, 0x0L, 0x0,1 },
    { 0x1c128, 0x0L, 0x0,4 },
    { 0x18ec0, 0x5L, 0x5,1 },                   // bypass rgbir & mirror (ping)
    { (0x18ec0+0x17fb0), 0x5L, 0x5,1 },         // bypass rgbir & mirror (pong)
    { 0x1aa20, 0x2L, 0x1f,1 },
    { 0x18ec4, 0x0L, 0xf,1 },
    ...
    { 0x18ecc, 0x2L, 0x303,2 },                 // bypass ds pipe (ping)
    { (0x18ecc+0x17fb0), 0x2L, 0x303,2 },       // bypass ds pipe (pong)
    ...
    // add 720p crop for debug
    { 0x1c028, 0x1, 0xff,1 },         // enable crop
    { 0x1c02c, 0x0, 0xffffffff,4 },   // start x
    { 0x1c030, 0x0, 0xffffffff,4 },   // start y
    { 0x1c034, 0x500, 0xffff,2 },     // size x
    { 0x1c038, 0x2d0, 0xffff,2 },     // size y
