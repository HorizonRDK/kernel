...
//	    { (0x18e8c+PONG_OFFSET), 0x303L, 0x303,4 },         // default change to bggr
 ...
 //   { (0x18ec0+PONG_OFFSET), 0x5L, 0x5,1 },         // bypass rgbir & mirror (pong)
    { 0x1aa20, 0x2L, 0x1f,1 },
    { 0x18ec4, 0x0L, 0xf,1 },
...
//    { (0x18ecc+PONG_OFFSET), 0x2L, 0x303,2 },       // bypass ds pipe (pong)
