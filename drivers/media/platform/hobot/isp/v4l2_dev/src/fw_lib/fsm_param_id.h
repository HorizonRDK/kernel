...
typedef enum {
    ...
    FSM_PARAM_SET_SENROR_TYPE,//add by myself
    FSM_PARAM_SET_SENSOR_I2C_CHANNEL,//add by myself
    FSM_PARAM_SET_SENSOR_MAX_AGAIN,//add by myself
    FSM_PARAM_SET_SENSOR_MAX_DGAIN,//add by myself
    FSM_PARAM_SET_SENSOR_MIN_INTERTIME,//add by myself
    FSM_PARAM_SET_SENSOR_MAX_INTERTIME,//add by myself
    FSM_PARAM_SET_SENSOR_MAX_LONGTIME,//add by myself
    FSM_PARAM_SET_SENSOR_LIMIT_INTERTIM,//add by myself
    FSM_PARAM_SET_SENSOR_LINES_PER_SECOND,//add by myself
    FSM_PARAM_SET_SENSOR_DECOMP_BITS,//IE&E add
    ...
    FSM_PARAM_SET_SENSOR_AWB_UPDATE,//IE&E add
    ...
    FSM_PARAM_SET_IRIDIX_LUT_RELOAD,
    ...
    FSM_PARAM_SET_MATRIX_YUV_UPDATE,
    ...
    FSM_PARAM_SET_ZOOM_MANUAL_POS,
    FSM_PARAM_SET_AF_UPDATE,
    FSM_PARAM_SET_AF_KERNEL_PARAM,
    FSM_PARAM_SET_AF_END,

    /* LCD */
    FSM_PARAM_SET_LDC_START,
    FSM_PARAM_SET_LDC_LINE_BUF,
    FSM_PARAM_SET_LDC_X_PARAM_A,
    FSM_PARAM_SET_LDC_X_PARAM_B,
    FSM_PARAM_SET_LDC_Y_PARAM_A,
    FSM_PARAM_SET_LDC_Y_PARAM_B,
    FSM_PARAM_SET_LDC_RADIUS_XOFFSET,
    FSM_PARAM_SET_LDC_RADIUS_YOFFSET,
    FSM_PARAM_SET_LDC_CENTER_XOFFSET,
    FSM_PARAM_SET_LDC_CENTER_YOFFSET,
    FSM_PARAM_SET_LDC_WOI_YLENGTH,
    FSM_PARAM_SET_LDC_WOI_YSTART,
    FSM_PARAM_SET_LDC_WOI_XLENGTH,
    FSM_PARAM_SET_LDC_WOI_XSTART,
    FSM_PARAM_SET_LDC_PARAM_UPDATE,
    FSM_PARAM_SET_LDC_BYPASS,
    FSM_PARAM_SET_LDC_END,
...
typedef enum {
    ...
    FSM_PARAM_GET_SENSOR_DECOMP_BITS,//IE&E add
    ...
    FSM_PARAM_GET_ZOOM_MANUAL_POS,
    FSM_PARAM_GET_AF_KERNEL_PARAM,
    FSM_PARAM_GET_AF_END,

    /* LCD */
    FSM_PARAM_GET_LDC_START,
    FSM_PARAM_GET_LDC_LINE_BUF,
    FSM_PARAM_GET_LDC_X_PARAM_A,
    FSM_PARAM_GET_LDC_X_PARAM_B,
    FSM_PARAM_GET_LDC_Y_PARAM_A,
    FSM_PARAM_GET_LDC_Y_PARAM_B,
    FSM_PARAM_GET_LDC_RADIUS_XOFFSET,
    FSM_PARAM_GET_LDC_RADIUS_YOFFSET,
    FSM_PARAM_GET_LDC_CENTER_XOFFSET,
    FSM_PARAM_GET_LDC_CENTER_YOFFSET,
    FSM_PARAM_GET_LDC_WOI_YLENGTH,
    FSM_PARAM_GET_LDC_WOI_YSTART,
    FSM_PARAM_GET_LDC_WOI_XLENGTH,
    FSM_PARAM_GET_LDC_WOI_XSTART,
    FSM_PARAM_GET_LDC_PARAM_UPDATE,
    FSM_PARAM_GET_LDC_BYPASS,
    FSM_PARAM_GET_LDC_END,
