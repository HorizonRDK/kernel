...
//#include "sif/x2a_sif_hw_reg.h"

//#include "ipu/ipu_hw_reg.h"
#include "pym/x2a_pym_hw_reg.h"
...
#if CONFIG_QEMU_TEST
	reg_value = *(u32 *) ((u8 *) base_addr + reg->sfr_offset);
	//if ((pym_regs[field->reg].sfr_offset + 0x200)!= reg->sfr_offset)
	//	vio_err("=========wrong reg===============\n");

#else
	reg_value = readl(base_addr + (reg->sfr_offset));
#endif
//	if((pym_regs[field->reg].sfr_offset)!= reg->sfr_offset)
//		vio_err("=========wrong reg===============\n");
